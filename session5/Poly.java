...
class Player implements Draw, Show {
  public void draw() { System.out.println("draw of player"); }
  public void show() { System.out.println("show in player"); }
}

class Ball implements Draw {
  public void draw() { System.out.println("draw of ball"); }
}

public class Poly {
  private static void drawer(Draw d) { d.draw(); }
